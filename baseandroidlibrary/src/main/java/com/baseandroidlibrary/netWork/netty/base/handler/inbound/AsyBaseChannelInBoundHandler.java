package com.baseandroidlibrary.netWork.netty.base.handler.inbound;

import android.util.Log;

import com.baseandroidlibrary.netWork.netty.base.businessHandler.BusinessEvent;
import com.baseandroidlibrary.netWork.netty.base.businessHandler.BusinessHandler;
import com.baseandroidlibrary.netWork.netty.synDataBack.nettySynInterface.NetMsgKeyForValue;
import com.baseandroidlibrary.netWork.netty.synDataBack.nettySynInterface.SynNettyEventRealize;
    ...
    public void channelRead(ChannelHandlerContext ctx, final Object msg) throws Exception {
        ...
        businessHandler.execute(new BusinessEvent() {
            ...
            public void Event() {
                ...
                Log.e("AsyBase", "netty super channelRead" + str);
                //保存消息，准备分发.
