 ...
 */
package com.androidcontrol.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.androidcontrol.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.androidcontrol.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
